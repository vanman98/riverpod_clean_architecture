...
abstract mixin class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, UserEntity? user, String? error});
}
...
extension AuthStatePatterns on AuthState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool isLoading, UserEntity? user, String? error)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AuthState() when $default != null:
        return $default(_that.isLoading, _that.user, _that.error);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(bool isLoading, UserEntity? user, String? error) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _AuthState():
...
class _AuthState extends AuthState {
  const _AuthState({this.isLoading = false, this.user, this.error}) : super._();
